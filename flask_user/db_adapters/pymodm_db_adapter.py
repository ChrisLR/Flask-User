...
class PYMODMDbAdapter(DbAdapterInterface):
    """ Implements the DbAdapter interface to find, add, update and delete
    database objects using PYODM.
    """

    def __init__(self, app, db):
        """Args:
            app(Flask): The Flask appliation instance.
            db(PYODM): The PYODM object-database mapper instance.
        ...
        super(PYMODMDbAdapter, self).__init__(app, db)
